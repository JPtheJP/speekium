...
enum ContextAwareCapitalizationE2E {
    static let launchArgument = "--speekium-e2e-context-aware-capitalization"
    private static let statusArgumentPrefix = "--speekium-e2e-status="
    private static let targetPIDArgumentPrefix = "--speekium-e2e-target-pid="
    ...
    static func run() {
        ...
        TextInserter.resolveTextBeforeCursor(
            ...
            DispatchQueue.main.asyncAfter(deadline: .now() + 1.0) {
                ...
                print(
                    "Speekium context-aware E2E injection completed "
    ...
    private static func fail(_ message: String) -> Never {
        ...
        fputs("Speekium context-aware E2E failed: \(message)\n", stderr)
        fflush(stderr)
        exit(EXIT_FAILURE)
    }
