...
final class AppUpdateManager: ObservableObject {
    ...
    init(
        repository: String? = ProcessInfo.processInfo.environment["SPEEKIUM_UPDATE_REPOSITORY"]
            ?? Bundle.main.object(forInfoDictionaryKey: "SpeekiumUpdateRepository") as? String,
