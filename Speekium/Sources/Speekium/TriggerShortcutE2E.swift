...
enum TriggerShortcutE2E {
    static let launchArgument = "--speekium-e2e-trigger-shortcut"
    ...
    static func run() {
        ...
        do {
            ...
            print("Speekium trigger-shortcut E2E passed")
            fflush(stdout)
            exit(EXIT_SUCCESS)
        } catch {
    ...
    private static func runAssertions() throws {
        let defaultsName = "SpeekiumTriggerShortcutE2E.\(ProcessInfo.processInfo.processIdentifier)"
    ...
    private static func fail(_ message: String) -> Never {
        ...
        fputs("Speekium trigger-shortcut E2E failed: \(message)\n", stderr)
        fflush(stderr)
        exit(EXIT_FAILURE)
    }
