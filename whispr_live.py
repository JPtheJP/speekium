#!/usr/bin/env python3
"""whispr-stream (live) — push-to-talk dictation that shows text WHILE you speak.
...
Usage:
    python whispr_live.py                  # push-to-talk, hold right option
    python whispr_live.py --simulate x.wav # replay a wav, no mic needed
"""
