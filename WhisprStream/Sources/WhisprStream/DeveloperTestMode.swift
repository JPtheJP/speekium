...
enum DeveloperTestMode {
    static let environmentKey = "WHISPR_TEST_FIRST_RUN"
    static let launchArgument = "--whispr-test-first-run"
...
extension Notification.Name {
    static let whisprDeveloperTestModeActivated = Notification.Name(
        "WhisprDeveloperTestModeActivated"
    )
}
