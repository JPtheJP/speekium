...
enum UpdateLaunchHealth {
    static let fileArgument = "--whispr-update-health-file"
    static let tokenArgument = "--whispr-update-health-token"
    ...
    static func request(
        ...
        guard parent.deletingLastPathComponent().standardizedFileURL == temporary,
              parent.lastPathComponent.hasPrefix("WhisprStream-installer-"),
