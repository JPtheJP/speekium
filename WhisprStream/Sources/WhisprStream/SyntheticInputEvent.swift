...
/// Tags keyboard events emitted by WhisprStream itself. The global shortcut
...
enum SyntheticInputEvent {
    private static let marker: Int64 = 0x5748_4953_5052_5354 // "WHISPRST"

    static func mark(_ event: CGEvent) {
        event.setIntegerValueField(.eventSourceUserData, value: marker)
    }

    static func wasGeneratedByWhisprStream(_ event: NSEvent) -> Bool {
