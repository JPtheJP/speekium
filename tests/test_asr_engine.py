...
MODULE_PATH = Path(__file__).parents[1] / "WhisprStream" / "Resources" / "asr_engine.py"
SPEC = importlib.util.spec_from_file_location("whispr_asr_engine", MODULE_PATH)
